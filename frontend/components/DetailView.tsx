...
export default function DetailView({
  ...
  useEffect(() => {
    if (post?.media_url) {
      setPostMediaUrl(absoluteUrl(post.media_url));
    }
  }, [post]);
  ...
  const toggleAmeiQuick = () =>
    applyReaction(userReaction === 'amei' ? null : 'amei');
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.sub}>{error || 'Erro desconhecido'}</Text>
        </View>
      </SafeAreaView>
    );
  }
            ...
            <View>
              <View style={styles.postPreview}>
                <View style={styles.authorRow}>
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={() => router.push(`/profile/${userHandle}`)}
                  >
                    {avatarUrl ? (
                      <Image
                  ...
                  <View style={styles.authorInfo}>
                    ...
                    <Text style={styles.authorHandle}>@{userHandle}</Text>
